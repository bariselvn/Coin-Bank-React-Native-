...
const DismissKeyboard=({children})=>(
 ...
 class VirmanScreen extends React.Component {
  constructor(props){
    super(props);
    this.virmanYap = this.virmanYap.bind(this);

    this.state = {
      MusteriID: props.MusteriID,
      ekNO: '',
      gonderilecekMusteriID: props.MusteriID,
      gonderilecekEkNo: '',
      miktar: '',
  ...
  virmanYap() {
    const EftHavale = {
      ...
      gonderilecekMusteriID: this.props.MusteriID,
...
const mapStateToProps = (state, ownProps) => ({
  ...
  export default connect(mapStateToProps)(VirmanScreen);
