...
const DismissKeyboard=({children})=>(
 ...
 class HesapSilmeScreen extends React.Component {
  constructor(props){
    super(props);
    this.hesapSil=this.hesapSil.bind(this);
    this.state={
      ekNO: '',
...
paddingVertical:10,
alignItems:'center'}}
onPress={this.hesapSil}>
  <Text style={{fontSize:16,color:'white'}} > HESABI SİL</Text>
</TouchableOpacity>
   </View>
  </ImageBackground>    
  </DismissKeyboard>           
...
export default connect(mapStateToProps)(HesapSilmeScreen);